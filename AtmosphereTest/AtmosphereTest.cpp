...
void generate_eye_views( int steps, const AtmosphereType::vec3_type& sunDir_, const AtmosphereType::mat4_type& rotMat, const AtmosphereType& atmos, const AtmosphereType::spectrum_type& Is, const AtmosphereType::vec3_type& eyePos, const AtmosphereType::vec3_type& upDir, const int ImageSize ) 
{
	...
	AtmosphereType::float_type mieg = AtmosphereType::get_g(AtmosphereType::float_type(0.8));
...
int main(int argc, _TCHAR* argv[])
{
	...
	atmos.set_radii(6378000, 6378000 + 100000);
	atmos.set_scale_height(9000);
	AtmosphereType::float_type Ns = AtmosphereType::float_type(0.02504e27);
	atmos.set_k(AtmosphereType::float_type(1.0003), Ns);
	atmos.set_light_wavelength(AtmosphereType::spectrum_type(AtmosphereType::float_type(0.000000700), AtmosphereType::float_type(0.000000550), AtmosphereType::float_type(0.000000460)));
	...
	//generate_density_tests(1.8e26, 2e27, 1.1, AtmosphereType::vec3_type(-1, 0, 0), atmos, Is, eyePos, upDir, ImageSize);
  	int steps = 25;
 	generate_eye_views(steps, 
		AtmosphereType::vec3_type(AtmosphereType::float_type(0), AtmosphereType::float_type(0), AtmosphereType::float_type(-1)), 
		AtmosphereType::mat4_type(rotatey(180.0 / steps)), atmos, Is, eyePos, upDir, ImageSize);
